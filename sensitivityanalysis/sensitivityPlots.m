...
semilogx(x5,exportDT_x(8:9,:),'LineWidth',1.5)
hold on
semilogx(x4,exportDT_x(10:14,:),'LineWidth',1.5)
title('export flux')
text(0.01, 0.95, 'Export flux [mgC/m^2/d]' ,'Units','normalized')
...
xlabel('radius [\mu m]')
ylabel('\mu g C m^{-2} d^{-1}') 
legend('a = 1.7','a = 1.8','a = 1.9','a = 2.0','a = 2.1','a = 2.2','a = 2.3','location','sw')
set(gca,'FontSize',14)
...
hold on
plot(2*x4*1E-4,monterey(2*x4*1E-4))
plot(2*x4*1E-4,slope(2*x4*1E-4,4),':')
title('Particle size spectrum')
xlabel('Particle Diameter [cm]')
ylabel('Number spectrum [# cm^{-4}]')
legend('\epsilon=10^{-4}','\epsilon=10^{-5}','\epsilon=10^{-6}','\epsilon=10^{-7}','monterey bay','slope=-4','Location','SouthWest')
set(gca,'FontSize',16)
...
xlabel('Particle Diameter [cm]')
ylabel('Number spectrum [# cm^{-4}]')
legend('\alpha = 0.1','\alpha = 0.3','\alpha = 0.5','\alpha = 0.7','monterey bay','slope=-4','Location','SouthWest')
set(gca,'FontSize',16)

print('./plots/spectrum_alpha.png', '-dpng', '-r400')

figure('Position', [300, 300, 700, 425])
loglog(2*x5*1E-4,NNN(9:10,:), 'LineWidth',1.5)
hold on
loglog(2*x4*1E-4,NNN(11:15,:), 'LineWidth',1.5)
plot(2*x4*1E-4,monterey(2*x4*1E-4))
plot(2*x4*1E-4,slope(2*x4*1E-4,4),':')
...
xlabel('Particle Diameter [cm]')
ylabel('Number spectrum [# cm^{-4}]')
legend('a = 1.7','a = 1.8','a = 1.9','a = 2.0','a = 2.1','a = 2.2','a = 2.3','monterey bay','slope=-4','Location','SouthWest')
set(gca,'FontSize',16)
